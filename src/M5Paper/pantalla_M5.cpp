...
void pantalla_M5::set_canvas(M5EPD_Canvas *ppCanvas){
    //pCanvas=ppCanvas;
}



void pantalla_M5::dibuja_cuerpo(){
    char szLocal[32];
...
void pantalla_M5::dibuja_flush(){
    canvas.pushCanvas(0,0,UPDATE_MODE_DU4);
}



void pantalla_M5::boton1(){
    strcpy(szLocalizacion,szgLocalizaciones[0]);
    loadJson(szLocalizacion);
    dibuja_cuerpo();
    canvas.pushCanvas(0,0,UPDATE_MODE_GC16    );
}
void pantalla_M5::boton2(){
...
void pantalla_M5::botonListado(int iIndicePulsado){
